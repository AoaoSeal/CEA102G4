...
<FORM METHOD="post" ACTION="<%= request.getContextPath()%>/front-end/bid/bid.do">
<div class="container">
	<div class="itTitle">
		 <jsp:useBean id="itSvc" scope="page" class="com.itinerary.model.ItService" />
		 <b>● 恭喜獲得競標行程:${itSvc.getOneIt(param.itNo).itName}    名額乙位</b>
	</div>
			...
			<div class="row justify-content-around">
				...
				<div class="rowBirth row1">
                    <div class="form-item">
                        ...
                        <input name="attBirth" type="text" class="date1" autocomplete="off">
                    </div>
                </div>
				...
				<div class="row2" id="peoCount">
                    <div class="form-item">
                    <input type="hidden" name="peoCount"  value="1">
	...
	<div class="itrow">
		<div class="col-1  offset-md-9">
			<div class="btnCom1">
		        ...
		        <input type="hidden" name="action" value="bidupdate">
